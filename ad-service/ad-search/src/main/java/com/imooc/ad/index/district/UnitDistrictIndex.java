...
public class UnitDistrictIndex implements IndexAware<String, Set<Long>> {
	...
	public boolean match(Long unitId, List<String> districts) {
		return unitDistrictMap.containsKey(unitId) && CollectionUtils.isNotEmpty(unitDistrictMap.get(unitId))
				&& CollectionUtils.isSubCollection(districts, unitDistrictMap.get(unitId));
	}
}
